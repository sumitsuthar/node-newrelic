...
| `@aws-sdk/client-bedrock-runtime` | 3.377.0 | 3.1046.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.377.0 | 3.1046.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.377.0 | 3.1046.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.377.0 | 3.1046.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.1046.0 | 8.7.1 |
| `@aws-sdk/smithy-client` | 3.47.0 | 3.374.0 | 8.7.1 |
| `@azure/functions` | 4.7.0 | 4.14.0 | 12.18.0 |
| `@elastic/elasticsearch` | 7.16.0 | 9.4.0 | 11.9.0 |
| `@google/adk` | 1.1.0 | 1.1.0 | 13.20.0 |
| `@google/genai` | 1.1.0 | 2.2.0 | 12.21.0 |
| `@grpc/grpc-js` | 1.4.0 | 1.14.3 | 8.17.0 |
| `@hapi/hapi` | 20.1.2 | 21.4.9 | 9.0.0 |
| `@koa/router` | 12.0.1 | 15.5.0 | 3.2.0 |
| `@langchain/aws` | 0.1.3 | 1.3.7 | 13.8.0 |
| `@langchain/core` | 0.2.0 | 1.1.46 | 11.13.0 |
| `@langchain/langgraph` | 1.0.0 | 1.3.0 | 13.12.0 |
| `@langchain/openai` | 0.2.0 | 1.4.5 | 11.13.0 |
| `@modelcontextprotocol/sdk` | 1.13.0 | 1.29.0 | 13.2.0 |
| `@nestjs/core` | 10.0.0 | 11.1.20 | 10.1.0 |
| `@opensearch-project/opensearch` | 2.1.0 | 3.6.0 | 12.10.0 |
| `@prisma/client` | 5.0.0 | 7.8.0 | 11.0.0 |
| `@smithy/smithy-client` | 2.0.0 | 4.13.2 | 11.0.0 |
